...
public interface TransactionService {
    void createAccountActivityForAccountStatusUpdate(Account account, AccountActivityType accountActivityType, TransactionInformation transactionInformation);
    void applyAccountActivityForSingleAccount(AccountActivityType accountActivityType, Double amount, Account account, String cashFlowExplanation, TransactionInformation transactionInformation);
