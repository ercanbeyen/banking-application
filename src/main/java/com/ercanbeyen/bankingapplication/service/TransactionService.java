...
public interface TransactionService {
    void createAccountActivityForAccountStatusUpdate(Account account, ActivityType activityType, TransactionInformation transactionInformation);
    void applyAccountActivityForSingleAccount(ActivityType activityType, Double amount, Account account, String cashFlowExplanation, TransactionInformation transactionInformation);
