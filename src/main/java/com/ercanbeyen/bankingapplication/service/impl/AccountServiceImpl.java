...
public class AccountServiceImpl implements AccountService {
    ...
    private void checkDailyAccountActivityLimit(Account account, Double amount, AccountActivityType accountActivityType, ChannelType channelType) {
        ChannelType channelTypeWithNoDailyAccountActivityLimit = DailyAccountActivityLimitUtil.getChannelTypeWithNoDailyAccountActivityLimit();
        ...
        List<Account> currentAccountsOfCustomer = account.getCustomer()
                .getAccounts()
                .stream()
                .filter(accountOfCustomer -> accountOfCustomer.getType() == AccountType.CURRENT)
                .toList();

        for (Account currentAccount : currentAccountsOfCustomer) {
