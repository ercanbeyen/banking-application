...
public class ExchangeController extends BaseController<ExchangeDto, ExchangeFilteringOptions> {
    ...
    public ResponseEntity<MessageResponse<String>> showExchangeResult(
        ...
        MessageResponse<String> response = new MessageResponse<>(exchangeService.showExchangeResult(fromCurrency, toCurrency, amount));
